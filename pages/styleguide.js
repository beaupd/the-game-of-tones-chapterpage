        ...
        <Main className="flex justify-center">
            ...
            <div className="container">
                ...
                <section className="my-24 relative">
                    ...
                    <ul className="flex w-full justify-center flex-wrap h-36">
                        <li className="flex-grow"><Color color="3F51B5">#3F51B5</Color></li>
                        <li className="flex-grow xl:px-3"><Color color="54BA54">#54BA54</Color></li>
                        <li className="flex-grow xl:px-3"><Color color="E7EF37">#E7EF37</Color></li>
                        <li className="flex-grow xl:px-3"><Color color="FF9400">#FF9400</Color></li>
                        <li className="flex-grow xl:px-3"><Color color="CDD5E9">#CDD5E9</Color></li>
                        <li className="flex-grow xl:px-3"><Color color="C8E8C7">#C8E8C7</Color></li>
                        <li className="flex-grow xl:px-3"><Color color="F4F4D7">#F4F4D7</Color></li>
                        <li className="flex-grow "><Color color="F9DDB3">#F9DDB3</Color></li>
                    </ul>
                </section>
